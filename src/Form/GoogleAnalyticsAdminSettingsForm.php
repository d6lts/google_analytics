...
class GoogleAnalyticsAdminSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $role_options = array_map(array('\Drupal\Component\Utility\SafeMarkup', 'checkPlain'), user_role_names());
    ...
    $site_search_dependencies .= t('Requires: !module-list', array('!module-list' => (\Drupal::moduleHandler()->moduleExists('search') ? t('@module (<span class="admin-enabled">enabled</span>)', array('@module' => 'Search')) : t('@module (<span class="admin-missing">disabled</span>)', array('@module' => 'Search')))));
