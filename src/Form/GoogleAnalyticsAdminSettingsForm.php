...
class GoogleAnalyticsAdminSettingsForm extends ConfigFormBase {
  ...
  protected static function validateCreateFieldName($name) {
    ...
    if ($name == 'allowLinker') {
      return t('Field name %name is a disallowed field name. Please select <em>Multiple top-level domains</em> under <em>What are you tracking</em> to enable cross domain tracking.');
    }
